  ...
  return (
    <div className="TechnologiesIcon">
      <div className="technologies-grid">
        <div>
          <img src={icon1} alt="Html icon" className="img-fluid icon"></img>
          <div className="text">HTML</div>
        </div>
        <div>
          <img src={icon2} alt="CSS icon" className="img-fluid icon"></img>
        ...
        <div>
          <img src={icon5} alt="API icon" className="img-fluid icon"></img>
          <div className="text">API</div>
        </div>
        <div>
          <img src={icon6} alt="Github icon" className="img-fluid icon"></img>
          <div className="text">Github</div>
        </div>
        <div>
          <img src={icon7} alt="Hosting icon" className="img-fluid icon"></img>
          <div className="text">Hosting</div>
        </div>
        <div>
          <img src={icon8} alt="Git icon" className="img-fluid icon"></img>
        ...
        <div>
          <img src={icon10} alt="SEO icon" className="img-fluid icon"></img>
        ...
        <div>
          <img src={icon12} alt="React icon" className="img-fluid icon"></img>
          <div className="text">React</div>
        </div>
        <div>
          <img src={icon13} alt="AI icon" className="img-fluid icon"></img>
